...
| 6 | 8MB SDRAM (IS42S16400J) | IS42S16400J-7TL | 1 | 180 | 180 | LCSC |
...
| 13 | Optical Wheel Encoder (600PPR) | E6B2-CWZ6C | 4 | 650 | 2,600 | Amazon |
...
| # | Component | Part Number | Qty | Unit Cost (₹) | Total (₹) | Supplier |
|---|-----------|-------------|-----|---------------|-----------|----------|
| 20 | OV5640 Camera Module (Red filter) | OV5640-AF | 1 | 600 | 600 | AliExpress |
| 21 | OV5640 Camera Module (NIR filter) | OV5640-AF | 1 | 600 | 600 | AliExpress |
...
| 25 | TFmini-S LiDAR Module | TFmini-S | 1 | 2,800 | 2,800 | Benewake |
...
| # | Component | Part Number | Qty | Unit Cost (₹) | Total (₹) | Supplier |
|---|-----------|-------------|-----|---------------|-----------|----------|
| 36 | HC-SR04 Ultrasonic Sensor | HC-SR04 | 4 | 80 | 320 | Amazon |
...
| 49 | 24V→5V Buck Converter (5A) | LM2596-5.0 | 2 | 80 | 160 | Amazon |
| 50 | 24V→3.3V Buck Converter (2A) | TPS563200 | 2 | 60 | 120 | LCSC |
| 51 | 24V→12V Buck Converter (3A) | XL4015 | 1 | 120 | 120 | Amazon |
...
| Category | Cost (₹) |
|----------|---------|
| Processing & Computing | 1,885 |
| Navigation & Positioning | 6,630 |
| Communication Modules | 1,325 |
| Plant Health Sensors | 5,400 |
| Soil Health Sensors | 9,850 |
| Environmental Sensors | 2,650 |
| Obstacle Detection | 320 |
...
| # | Component | Part Number | Qty | Unit Cost (₹) | Total (₹) | Supplier |
|---|-----------|-------------|-----|---------------|-----------|----------|
| 3 | 3.5" TFT LCD 480×320 (ILI9488) | MSP3520 | 1 | 800 | 800 | AliExpress |
...
| 17 | Status LEDs (RGB, WS2812B) | WS2812B-2020 | 4 | 8 | 32 | LCSC |

### 2.6 Power

| # | Component | Part Number | Qty | Unit Cost (₹) | Total (₹) | Supplier |
|---|-----------|-------------|-----|---------------|-----------|----------|
| 18 | LiPo Battery 3.7V 3000mAh | 103565 | 1 | 350 | 350 | Amazon |
| 19 | TP4056 USB-C Charge Controller | TP4056 | 1 | 25 | 25 | LCSC |
| 20 | MCP73871 Charge + Load Share | MCP73871-2CCI | 1 | 120 | 120 | Mouser |
...
| Storage | 295 |
| PCB & Enclosure | 5,400 |
| **CONTROLLER TOTAL** | **₹11,397** |
| **USD Equivalent (~₹83)** | **~$137** |
...
| Item | Cost (₹) | Cost ($) |
|------|---------|---------|
| Robot (1 unit) | 100,188 | ~1,207 |
| Controller (1 unit) | 11,397 | ~137 |
| Assembly & Testing (est.) | 15,000 | ~181 |
| Miscellaneous (wires, tools, consumables) | 5,000 | ~60 |
| **TOTAL PROJECT COST** | **₹131,585** | **~$1,585** |
