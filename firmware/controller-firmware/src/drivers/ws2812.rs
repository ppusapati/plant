...
//!
//! 4× WS2812B LEDs daisy-chained on GPIO45.
...
/// RGB color (GRB order for WS2812B)
...
impl RgbColor {
    ...
    /// Convert to GRB byte order for WS2812B
...
impl LedController {
    ...
    /// Generate WS2812B bit stream data
    /// Each bit is represented as a specific timing pattern
    /// For actual transmission, use RMT peripheral on ESP32-S3
